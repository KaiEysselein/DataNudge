...
**Current GitHub release tag:** `v0.1.1.0`  
...
```text
https://github.com/KaiEysselein/DataNudge/releases/tag/v0.1.1.0
```

### Direct APK

```text
https://github.com/KaiEysselein/DataNudge/releases/download/v0.1.1.0/DataNudge-0.1.1.0.apk
```
...
The next planned bug-fix release is `0.1.1.0`.
