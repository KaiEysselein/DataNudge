...
**Current GitHub release tag:** `v0.1.0.2`  
...
```text
https://github.com/KaiEysselein/DataNudge/releases/tag/v0.1.0.2
```

### Direct APK

```text
https://github.com/KaiEysselein/DataNudge/releases/download/v0.1.0.2/DataNudge-0.1.0.2.apk
```
