...
**Current released version:** `0.1.0.3`  
**Current GitHub release tag:** `v0.1.0.3`  
...
```text
https://github.com/KaiEysselein/DataNudge/releases/tag/v0.1.0.3
```

### Direct APK

```text
https://github.com/KaiEysselein/DataNudge/releases/download/v0.1.0.3/DataNudge-0.1.0.3.apk
```
...
The next planned bug-fix release is `0.1.0.3`.
